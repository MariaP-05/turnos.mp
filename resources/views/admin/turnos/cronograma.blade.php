                            ...
                            @foreach ($minutos as $minuto)
                                <tr>
                                                    ...
                                                    <div class= "col-md-12 form-group">
                                                        <div class="row">
                                                            ...
                                                            <form method="get"
                                                                ...
                                                                <button type="submit" class="info-box-icon btn-secondary"
                                                            ...
                                                            <button type="submit" class="info-box-icon btn-secondary" 
                                                            style="border-radius: 50%; width:30px;	height:30px; "  onMouseOver="this.style.background='#dc3545'; this.style.border='#dc3545'" 
                                                            onMouseOut="this.style.background = '#6C757D'; this.style.border='#6C757D'"
                                    ...
                                    {{ $turno->id_estado_turnos != 1 ? $turno->EstadoTurno->color
                                        : (isset($turno->TipoTurno)  ? $turno->TipoTurno->color  : null) }}
