                    ...
                    <div class="row">
                        @foreach ($eva as $archivo)
                            <div class="info-card bg-secondary col-lg-12 col-md-6 col-xs-6">
                                ...
                                <div class="card-body">
                                    @if (
                                        $archivo['extension'] !== 'jpg' &&
                                            ...
                                            $archivo['extension'] !== 'tiff' &&
                                            $archivo['extension'] !== 'tif' &&
                                            $archivo['extension'] !== 'raw' &&
                                            $archivo['extension'] !== 'bmp' &&
                                        ...
                                        @if (
                                            ...
                                            <embed name="plugin"
                                                src="{{ url('storage/pacientes/' . $id . '/archivos/' . $archivo['nombre']) }}"
                                                type="application/pdf" style="width: 100%; height: 500px ">
                                        @else
                                            <img src="{{ url('storage/pacientes/' . $id . '/archivos/' . $archivo['nombre']) }}"
                                                style="width: 100% ; height: auto " class="center-block">
                                        @endif
                                    @else
                                        <img src="{{ url('storage/pacientes/' . $id . '/archivos/' . $archivo['nombre']) }}"
                                            style="width: 100% ; height: auto " class="center-block">
                                ...
                                <a href="{{ route('admin.pacientes.download', ['id' => $id, 'file_name' => $archivo['nombre']]) }}"
                                    class="btn btn-xs btn-primary " title="Descargar" role="button">
                                    <i class="fa fa-download"></i></a>

                                <a type="button" href="{{ url('storage/pacientes/' . $id . '/archivos/' . $archivo['nombre']) }}"
