...
@section('title', 'Nuevo Profesional Afin')


@section('content_header')
<h1>Nuevo Profesional Afin</h1>
@stop
        ...
        <div class="col-xs-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    {{ Form::model($profesional,['route'=>['admin.profesionales_afines.update', $profesional->id],'method' => 'PUT', 'role'=>'form', 'data-toggle'=>'validator']) }}
                    @else
                    {{ Form::open(['route' => 'admin.profesionales_afines.store','method'=>'POST', 'role'=>'form', 'data-toggle'=>'validator']) }}
                    @endif
                    ...
                    <div class="box-footer col-md-6 form-group pull-right ">
                        <a type="button" class="btn btn-outline-danger" href="{{route('admin.profesionales_afines.index')}}">{{ trans('message.close') }}</a>
